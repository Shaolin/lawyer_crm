...
<head>
    ...
    <title>Pricing – Law Office Pro for Lawyers</title>
    ...
    <section class="relative bg-gradient-to-r from-indigo-900 to-purple-800 text-white">
        <div class="max-w-7xl mx-auto px-6 py-24 text-center">
            ...
            <p class="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
                Whether you’re a solo lawyer or managing a mid-sized chamber, Law Office Pro has a plan that fits your needs and budget.
            </p>
        </div>
    </section>
            ...
            <div class="mt-16 grid gap-8 md:grid-cols-3">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-10 border border-gray-200 hover:shadow-xl transition relative">
                    ...
                    <p class="mt-6 text-2xl font-extrabold text-gray-900">
                        ₦15,000<span class="text-lg font-medium text-gray-600">/month</span>
                    </p>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-10 border border-gray-200 hover:shadow-xl transition relative">
                    ...
                    <p class="mt-6 text-2xl font-extrabold text-gray-900">
                        ₦25,000<span class="text-lg font-medium text-gray-600">/month</span>
                    </p>
                    <ul class="mt-6 space-y-3 text-gray-700">
                        <li>✔ Case Tracking</li>
