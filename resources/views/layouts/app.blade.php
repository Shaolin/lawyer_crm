...
<div class="fixed bottom-4 left-0 w-full flex justify-between items-center px-4 z-50 gap-2 sm:gap-4">

    @auth
        <!-- Back to Home -->
        <a href="{{ url('/') }}"
           class="inline-flex items-center px-3 py-2 text-xs sm:text-sm font-medium text-indigo-600 bg-white border border-indigo-600 rounded-full shadow-md hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition
